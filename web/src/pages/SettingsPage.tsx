      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className={settingsColumns}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Card title={t("settings.brandingLegend")}>
              <div className="flex flex-col gap-4">
                <p className="text-[length:var(--font-size-sm)] text-[var(--color-fg-muted)]">
                ...
                <Field label={t("settings.brandingProductName")}>
                  <Input
                ...
                <Field
                  label={t("settings.brandingLoginHeading")}
                  hint={t("settings.brandingLoginHeadingHelp")}
                >
                  <Input
                ...
                <Field
                  label={t("settings.brandingColorPrimary")}
                  hint={t("settings.brandingColorPrimaryHelp")}
                >
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      // through the API and what a copy-pasted brand hex
                      // lands in, and the picker is a convenience for
                      // choosing one from scratch.
                ...
                <Field
                  label={t("settings.brandingFontFamily")}
                  hint={t("settings.brandingFontFamilyHelp")}
                >
                  <Input
                ...
                <Field
                  label={t("settings.brandingBgImageUrl")}
                  hint={t("settings.brandingBgImageUrlHelp")}
                >
                  <Input
                ...
                <Field
                  label={t("settings.brandingFooterPrivacyUrl")}
                  hint={t("settings.brandingFooterLinkHelp")}
                >
                  <Input
                    value={settings.brandingFooterPrivacyUrl}
                    placeholder="https://example.com/privacy"
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        brandingFooterPrivacyUrl: e.target.value,
                      })
                    }
                  />
                </Field>

                <Field label={t("settings.brandingFooterTermsUrl")}>
                  <Input
                    value={settings.brandingFooterTermsUrl}
                    placeholder="https://example.com/terms"
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        brandingFooterTermsUrl: e.target.value,
                      })
                    }
                  />
                </Field>

                <Field label={t("settings.brandingFooterSupportUrl")}>
                  <Input
                    value={settings.brandingFooterSupportUrl}
                    placeholder="mailto:support@example.com"
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        brandingFooterSupportUrl: e.target.value,
                      })
                    }
                  />
                </Field>
