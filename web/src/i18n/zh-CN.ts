...
export const zhCN: Record<keyof typeof enUS, string> = {
  ...
  "nav.settingsBranding": "品牌定制",

  "branding.title": "品牌定制",
  "branding.subtitle":
    "仅作用于登录、注册、找回密码三个页面，管理控制台外观不变。",
  "branding.fieldsLegend": "外观",
  "branding.previewLegend": "预览",
  "branding.previewHelp": "随左侧字段实时更新，按下保存前不会生效。",
  "branding.productName": "产品名称",
  "branding.loginHeading": "登录页标题",
  "branding.loginHeadingHelp": "替换默认的登录页标题，留空则使用默认文案。",
  ...
  "branding.footerMode": "展示方式",
  "branding.footerModeOff": "不显示",
  "branding.footerModeLink": "外部链接",
  "branding.footerModeText": "站内正文",
  ...
  "tenants.scopeNote":
    "本页仅显示各租户的规模，不能查看其中的任何具体数据。租户的创建与删除仍需通过命令行。",
  ...
  "tenants.colExpires": "到期",
  "tenants.noExpiry": "不过期",
  "tenants.expiresInDays": "还有 {0} 天",
  "tenants.expired": "已过期 —— 已停用",
  "tenants.extend": "延长",
  ...
  "tenants.disableWarning":
    "该租户下所有人将被立即登出，{0} 个正常账号无法再登录，且不会收到任何通知。不会删除任何数据，重新启用即可完全恢复。",
  "tenants.enableBody": "该租户将恢复登录。",
  "tenants.confirmLabel": "输入租户编码以确认",
  "tenants.confirmHint":
    "请准确输入该租户的编码。服务端会再次校验，无法通过脚本跳过。",

  "trial.title": "试用 Portico",
  "trial.subtitle": "一个属于你自己的租户，附带一个管理员账号。",
  "trial.step.fill": "填写并提交",
  "trial.step.confirm": "打开邮件中的链接",
  "trial.step.ready": "获取租户与凭据",
  "trial.stepNote": "链接 24 小时内有效。打开链接后才会创建租户。",
  "trial.email": "邮箱地址",
  "trial.emailHint":
    "确认链接与后续的管理员凭据均发送至此地址，请确认填写无误。",
  "trial.tenantCode": "租户编码",
  "trial.tenantCodeHint": "登录时需填写此编码。仅限小写，创建后不可修改。",
  ...
  "trial.sentTitle": "请查收邮件",
  "trial.sentBody": "链接 24 小时内有效。打开链接后才会创建租户。",
  "trial.sentTo": "已发送至 {0}",
  "trial.sentEdit": "修改邮箱地址",
  "trialConfirm.workingTitle": "正在准备你的租户",
  "trialConfirm.working":
    "正在创建租户并写入示例数据。此过程需要几秒钟，请勿关闭本页面。",
  "trialConfirm.failedTitle": "创建失败",
  "trialConfirm.startAgain": "重新申请试用",
  "trialConfirm.noToken": "本页需要邮件中的确认链接，当前地址未携带令牌。",
  "trialConfirm.readyTitle": "你的租户已就绪",
  "trialConfirm.ready": "{0} 已创建完成，以下是登录所需的凭据。",
  ...
  "trialConfirm.demoAccounts":
    "租户中已预置示例人员与应用。这些账号均为普通用户，共用上述密码；使用其中任意一个登录，即可查看非管理员视角下的门户。",
  "trialConfirm.emptyTenant":
    "本次未写入示例数据，租户为空。租户仍可正常使用，组织与账号可自行创建。",
  "trialConfirm.onlyTime":
    "密码只在这里显示这一次。邮件里也有一份；系统不会以任何可读形式保存它。",
  "trialConfirm.notReal": "此处为演示环境，非正式部署。请勿录入真实数据。",
  "trialConfirm.signInHint": "登录时，租户一栏请填写",
  "trialConfirm.signIn": "前往登录",
  "verify.noToken":
