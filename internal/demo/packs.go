...
var manufacturingPack = Pack{
	...
	People: []Person{
		{Username: "linjianguo", DisplayName: "林建国", Email: "lin.jg@example-mfg.com",
			Phone: "13910000001", Org: "east", Source: model.SourceAdmin},
		{Username: "hexiaoming", DisplayName: "何晓明", Email: "he.xm@example-mfg.com",
			Phone: "13910000002", Org: "assembly", Source: model.SourceAdmin},
		{Username: "guoping", DisplayName: "郭平", Email: "guo.p@example-mfg.com",
			Org: "assembly", Source: model.SourceLDAP},
		{Username: "xuhaiyan", DisplayName: "徐海燕", Email: "xu.hy@example-mfg.com",
			Phone: "13910000004", Org: "assembly", Source: model.SourceLDAP},
		{Username: "machao", DisplayName: "马超", Email: "ma.c@example-mfg.com",
			Org: "stamping", Source: model.SourceImport},
		{Username: "dengli", DisplayName: "邓丽", Email: "deng.l@example-mfg.com",
			Phone: "13910000006", Org: "stamping", Source: model.SourceLDAP},
		{Username: "fengyu", DisplayName: "冯宇", Org: "stamping",
			Source: model.SourceImport, NoContact: true},
		{Username: "tangwei", DisplayName: "唐伟", Email: "tang.w@example-mfg.com",
			Phone: "13910000008", Org: "quality", Source: model.SourceAdmin},
		{Username: "yaolin", DisplayName: "姚琳", Email: "yao.l@example-mfg.com",
			Org: "quality", Source: model.SourceAdmin},
		{Username: "shenbin", DisplayName: "沈斌", Email: "shen.b@example-mfg.com",
			Phone: "13910000010", Org: "quality", Source: model.SourceSCIM},
		{Username: "cuiyan", DisplayName: "崔燕", Email: "cui.y@example-mfg.com",
			Org: "supply", Source: model.SourceLDAP},
		{Username: "panjun", DisplayName: "潘军", Email: "pan.j@example-mfg.com",
			Phone: "13910000012", Org: "supply", Source: model.SourceImport},
		{Username: "shiyong", DisplayName: "石勇", Email: "shi.y@example-mfg.com",
			Org: "supply", Source: model.SourceSCIM},
		{Username: "gone.from.south", DisplayName: "华南厂区留档", Email: "south@example-mfg.com",
	...
	OAuth: []OAuthApp{
		{ClientID: "mes", Name: "MES 制造执行系统", Type: model.AppTypeWeb,
			Redirect: []string{"https://mes.example-mfg.com/oidc/callback"},
			Scopes:   []string{"openid", "profile", "groups"},
			Launch:   "https://mes.example-mfg.com/"},
		{ClientID: "andon-board", Name: "车间安灯看板", Type: model.AppTypeUserAgent, Public: true,
			Redirect: []string{"https://andon.example-mfg.com/callback"},
			Scopes:   []string{"openid", "profile"},
			Launch:   "https://andon.example-mfg.com/"},
	},
	SAML: []SAMLApp{
		{Name: "ERP（SAML）", EntityID: "https://erp.example-mfg.com/saml/metadata",
			Host: "erp.example-mfg.com", Launch: "https://erp.example-mfg.com/"},
	},
	CAS: []CASApp{
		{Name: "设备管理（CAS，已停用）", Prefix: "https://eam.example-mfg.com/",
			Disabled: true},
	},
...
var bankingPack = Pack{
	...
	People: []Person{
		{Username: "yuandong", DisplayName: "袁东", Email: "yuan.d@example-bank.com",
			Phone: "13710000001", Org: "head", Source: model.SourceAdmin},
		{Username: "qiaoshan", DisplayName: "乔珊", Email: "qiao.s@example-bank.com",
			Org: "retail", Source: model.SourceAdmin},
		{Username: "luyifan", DisplayName: "陆一凡", Email: "lu.yf@example-bank.com",
			Phone: "13710000003", Org: "shanghai", Source: model.SourceLDAP},
		{Username: "hantong", DisplayName: "韩彤", Email: "han.t@example-bank.com",
			Org: "jingan", Source: model.SourceLDAP},
		{Username: "baiyu", DisplayName: "白宇", Email: "bai.y@example-bank.com",
			Phone: "13710000005", Org: "jingan", Source: model.SourceLDAP},
		{Username: "kongxiang", DisplayName: "孔祥", Email: "kong.x@example-bank.com",
			Org: "jingan", Source: model.SourceImport},
		{Username: "leiming", DisplayName: "雷鸣", Email: "lei.m@example-bank.com",
			Phone: "13710000007", Org: "hongkou", Source: model.SourceLDAP},
		{Username: "duanqing", DisplayName: "段青", Email: "duan.q@example-bank.com",
			Org: "hongkou", Source: model.SourceLDAP},
		{Username: "yanru", DisplayName: "阎茹", Email: "yan.r@example-bank.com",
			Phone: "13710000009", Org: "corporate", Source: model.SourceAdmin},
		{Username: "moshaowen", DisplayName: "莫少文", Email: "mo.sw@example-bank.com",
			Org: "corporate", Source: model.SourceSCIM},
		{Username: "jiangbo", DisplayName: "姜波", Email: "jiang.b@example-bank.com",
			Phone: "13710000011", Org: "risk", Source: model.SourceAdmin},
		{Username: "wenjia", DisplayName: "温佳", Email: "wen.j@example-bank.com",
			Org: "risk", Source: model.SourceAdmin},
		{Username: "auditor.readonly", DisplayName: "外部审计（只读）",
			Email: "audit@example-audit.com", Org: "risk", Source: model.SourceRegistration},
		{Username: "transferred.out", DisplayName: "已调离", Email: "left@example-bank.com",
	...
	OAuth: []OAuthApp{
		{ClientID: "ebank-console", Name: "网银运营后台", Type: model.AppTypeWeb,
			Redirect: []string{"https://ops.example-bank.com/oauth2/callback"},
			Scopes:   []string{"openid", "profile", "email", "groups"},
			Launch:   "https://ops.example-bank.com/"},
		{ClientID: "risk-portal", Name: "风控平台", Type: model.AppTypeWeb,
			Redirect: []string{"https://risk.example-bank.com/callback"},
			Scopes:   []string{"openid", "profile", "groups"},
			Launch:   "https://risk.example-bank.com/"},
	...
	SAML: []SAMLApp{
		{Name: "核心业务系统（SAML）", EntityID: "https://core.example-bank.com/saml/metadata",
			Host: "core.example-bank.com", Launch: "https://core.example-bank.com/"},
	},
...
var hospitalPack = Pack{
	...
	People: []Person{
		{Username: "shenyuqing", DisplayName: "沈玉清", Email: "shen.yq@example-hosp.com",
			Phone: "13610000001", Org: "internal", Source: model.SourceAdmin},
		{Username: "luowenbo", DisplayName: "罗文博", Email: "luo.wb@example-hosp.com",
			Org: "internal", Source: model.SourceLDAP},
		{Username: "jiangyue", DisplayName: "蒋玥", Email: "jiang.y@example-hosp.com",
			Phone: "13610000003", Org: "surgery", Source: model.SourceLDAP},
		{Username: "songkai", DisplayName: "宋凯", Email: "song.k@example-hosp.com",
			Org: "surgery", Source: model.SourceLDAP},
		{Username: "yeqian", DisplayName: "叶倩", Email: "ye.q@example-hosp.com",
			Phone: "13610000005", Org: "emergency", Source: model.SourceAdmin},
		{Username: "fanzhihao", DisplayName: "范志豪", Email: "fan.zh@example-hosp.com",
			Org: "emergency", Source: model.SourceLDAP},
		{Username: "qiuxin", DisplayName: "邱欣", Org: "emergency",
			Source: model.SourceImport, NoContact: true},
		{Username: "biyunfei", DisplayName: "毕云飞", Email: "bi.yf@example-hosp.com",
			Phone: "13610000008", Org: "imaging", Source: model.SourceLDAP},
		{Username: "tanmeng", DisplayName: "谭萌", Email: "tan.m@example-hosp.com",
			Org: "pharmacy", Source: model.SourceLDAP},
		{Username: "houjing", DisplayName: "侯静", Email: "hou.j@example-hosp.com",
			Phone: "13610000010", Org: "nursing", Source: model.SourceSCIM},
		{Username: "kangxiaoyu", DisplayName: "康小雨", Email: "kang.xy@example-hosp.com",
			Org: "nursing", Source: model.SourceSCIM},
		{Username: "guyan", DisplayName: "顾岩", Email: "gu.y@example-hosp.com",
			Phone: "13610000012", Org: "nursing", Source: model.SourceSCIM},
		{Username: "weichun", DisplayName: "魏春", Email: "wei.c@example-hosp.com",
			Org: "admin", Source: model.SourceAdmin},
		{Username: "retired.doctor", DisplayName: "已退休（返聘中止）",
			Email: "retired@example-hosp.com", Org: "internal",
	...
	OAuth: []OAuthApp{
		{ClientID: "pacs", Name: "PACS 影像系统", Type: model.AppTypeWeb,
			Redirect: []string{"https://pacs.example-hosp.com/oidc/callback"},
			Scopes:   []string{"openid", "profile", "groups"},
			Launch:   "https://pacs.example-hosp.com/"},
	},
	SAML: []SAMLApp{
		{Name: "电子病历（SAML）", EntityID: "https://emr.example-hosp.com/saml/metadata",
			Host: "emr.example-hosp.com", Launch: "https://emr.example-hosp.com/"},
	},
	CAS: []CASApp{
		{Name: "HIS 住院医生站（CAS）", Prefix: "https://his.example-hosp.com/",
			Launch: "https://his.example-hosp.com/"},
		{Name: "药房管理（CAS，已停用）", Prefix: "https://pharmacy.example-hosp.com/",
			Disabled: true},
	},
...
var universityPack = Pack{
	...
	People: []Person{
		{Username: "shangguanrui", DisplayName: "上官睿", Email: "sgr@example-edu.cn",
			Phone: "13510000001", Org: "cs", Source: model.SourceAdmin},
		{Username: "muhaoran", DisplayName: "穆浩然", Email: "mhr@example-edu.cn",
			Org: "cs", Source: model.SourceLDAP},
		{Username: "s2024010", DisplayName: "student-2024010", Email: "s2024010@example-edu.cn",
			Org: "cs", Source: model.SourceSCIM},
		{Username: "s2024011", DisplayName: "student-2024011", Email: "s2024011@example-edu.cn",
			Org: "cs", Source: model.SourceSCIM},
		{Username: "s2023077", DisplayName: "student-2023077", Email: "s2023077@example-edu.cn",
			Org: "math", Source: model.SourceSCIM},
		{Username: "qinshuang", DisplayName: "秦爽", Email: "qs@example-edu.cn",
			Phone: "13510000006", Org: "math", Source: model.SourceLDAP},
		{Username: "yinzhe", DisplayName: "尹哲", Email: "yz@example-edu.cn",
			Org: "math", Source: model.SourceLDAP},
		{Username: "tomas.novak", DisplayName: "Tomáš Novák", Email: "novak@example-edu.cn",
			Org: "fl", Source: model.SourceLDAP},
		{Username: "buyunxi", DisplayName: "卜韵溪", Email: "byx@example-edu.cn",
			Phone: "13510000009", Org: "fl", Source: model.SourceAdmin},
		{Username: "louzhen", DisplayName: "娄真", Email: "lz@example-edu.cn",
			Org: "registry", Source: model.SourceAdmin},
		{Username: "yuwenqi", DisplayName: "宇文琪", Email: "ywq@example-edu.cn",
			Phone: "13510000011", Org: "registry", Source: model.SourceAdmin},
		{Username: "chuhang", DisplayName: "褚航", Email: "ch@example-edu.cn",
			Org: "library", Source: model.SourceImport},
		{Username: "visiting.scholar", DisplayName: "访问学者（学期制）",
			Email: "visitor@example-edu.cn", Org: "fl", Source: model.SourceRegistration},
		{Username: "graduated", DisplayName: "已毕业", Email: "alumni@example-edu.cn",
	...
	OAuth: []OAuthApp{
		{ClientID: "research-portal", Name: "科研管理平台", Type: model.AppTypeWeb,
			Redirect: []string{"https://research.example-edu.cn/oauth2/callback"},
			Scopes:   []string{"openid", "profile", "email"},
			Launch:   "https://research.example-edu.cn/"},
	},
	SAML: []SAMLApp{
		{Name: "Moodle 课程平台（SAML）", EntityID: "https://moodle.example-edu.cn/saml/metadata",
			Host: "moodle.example-edu.cn", Launch: "https://moodle.example-edu.cn/"},
	},
	CAS: []CASApp{
		{Name: "教务系统（CAS）", Prefix: "https://jw.example-edu.cn/",
			Launch: "https://jw.example-edu.cn/"},
		{Name: "图书馆（CAS）", Prefix: "https://lib.example-edu.cn/",
			Launch: "https://lib.example-edu.cn/"},
	},
